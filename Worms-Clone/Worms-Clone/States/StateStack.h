...
public:
	 ...
	 *
	 * By default it of course just pass an information to the factory how to create such
	 ...
	 *
	 * Previously, the StateStack must have saved the specified identifier via the saveState function.
	 * This function just uses the identifier to create an object of the given state class using a factory.
	 */
